...
const Portfolio = () => {
  ...
  const [chartData, setChartData] = useState(() => {
    ...
    return [
      { time: '200m', open: basePrice * 0.05, high: basePrice * 0.08, low: basePrice * 0.04, close: basePrice * 0.06, isGreen: true },
      { time: '195m', open: basePrice * 0.06, high: basePrice * 0.09, low: basePrice * 0.05, close: basePrice * 0.07, isGreen: true },
      { time: '190m', open: basePrice * 0.07, high: basePrice * 0.10, low: basePrice * 0.06, close: basePrice * 0.08, isGreen: true },
      { time: '185m', open: basePrice * 0.08, high: basePrice * 0.11, low: basePrice * 0.07, close: basePrice * 0.09, isGreen: true },
      { time: '180m', open: basePrice * 0.09, high: basePrice * 0.12, low: basePrice * 0.08, close: basePrice * 0.10, isGreen: true },
      { time: '175m', open: basePrice * 0.10, high: basePrice * 0.13, low: basePrice * 0.09, close: basePrice * 0.11, isGreen: true },
      { time: '170m', open: basePrice * 0.11, high: basePrice * 0.14, low: basePrice * 0.10, close: basePrice * 0.12, isGreen: true },
      { time: '165m', open: basePrice * 0.12, high: basePrice * 0.15, low: basePrice * 0.11, close: basePrice * 0.13, isGreen: true },
      { time: '160m', open: basePrice * 0.13, high: basePrice * 0.16, low: basePrice * 0.12, close: basePrice * 0.14, isGreen: true },
      { time: '155m', open: basePrice * 0.14, high: basePrice * 0.17, low: basePrice * 0.13, close: basePrice * 0.15, isGreen: true },
      { time: '150m', open: basePrice * 0.15, high: basePrice * 0.18, low: basePrice * 0.14, close: basePrice * 0.16, isGreen: true },
      { time: '145m', open: basePrice * 0.16, high: basePrice * 0.19, low: basePrice * 0.15, close: basePrice * 0.17, isGreen: true },
      { time: '140m', open: basePrice * 0.17, high: basePrice * 0.20, low: basePrice * 0.16, close: basePrice * 0.18, isGreen: true },
      { time: '135m', open: basePrice * 0.18, high: basePrice * 0.21, low: basePrice * 0.17, close: basePrice * 0.19, isGreen: true },
      { time: '130m', open: basePrice * 0.19, high: basePrice * 0.22, low: basePrice * 0.18, close: basePrice * 0.20, isGreen: true },
      { time: '125m', open: basePrice * 0.20, high: basePrice * 0.23, low: basePrice * 0.19, close: basePrice * 0.21, isGreen: true },
      { time: '120m', open: basePrice * 0.21, high: basePrice * 0.24, low: basePrice * 0.20, close: basePrice * 0.22, isGreen: true },
      { time: '115m', open: basePrice * 0.22, high: basePrice * 0.25, low: basePrice * 0.21, close: basePrice * 0.23, isGreen: true },
      { time: '110m', open: basePrice * 0.23, high: basePrice * 0.26, low: basePrice * 0.22, close: basePrice * 0.24, isGreen: true },
      { time: '105m', open: basePrice * 0.24, high: basePrice * 0.27, low: basePrice * 0.23, close: basePrice * 0.25, isGreen: true },
      { time: '100m', open: basePrice * 0.25, high: basePrice * 0.28, low: basePrice * 0.24, close: basePrice * 0.26, isGreen: true },
      { time: '95m', open: basePrice * 0.26, high: basePrice * 0.29, low: basePrice * 0.25, close: basePrice * 0.27, isGreen: true },
      { time: '90m', open: basePrice * 0.27, high: basePrice * 0.30, low: basePrice * 0.26, close: basePrice * 0.28, isGreen: true },
      { time: '85m', open: basePrice * 0.28, high: basePrice * 0.31, low: basePrice * 0.27, close: basePrice * 0.29, isGreen: true },
      { time: '80m', open: basePrice * 0.29, high: basePrice * 0.32, low: basePrice * 0.28, close: basePrice * 0.30, isGreen: true },
      { time: '75m', open: basePrice * 0.30, high: basePrice * 0.33, low: basePrice * 0.29, close: basePrice * 0.31, isGreen: true },
      { time: '70m', open: basePrice * 0.31, high: basePrice * 0.34, low: basePrice * 0.30, close: basePrice * 0.32, isGreen: true },
      { time: '65m', open: basePrice * 0.32, high: basePrice * 0.35, low: basePrice * 0.31, close: basePrice * 0.33, isGreen: true },
      { time: '60m', open: basePrice * 0.33, high: basePrice * 0.36, low: basePrice * 0.32, close: basePrice * 0.34, isGreen: true },
      { time: '55m', open: basePrice * 0.34, high: basePrice * 0.37, low: basePrice * 0.33, close: basePrice * 0.35, isGreen: true },
      { time: '50m', open: basePrice * 0.35, high: basePrice * 0.38, low: basePrice * 0.34, close: basePrice * 0.36, isGreen: true },
      { time: '48m', open: basePrice * 0.36, high: basePrice * 0.39, low: basePrice * 0.35, close: basePrice * 0.37, isGreen: true },
      { time: '46m', open: basePrice * 0.37, high: basePrice * 0.40, low: basePrice * 0.36, close: basePrice * 0.38, isGreen: true },
      { time: '44m', open: basePrice * 0.38, high: basePrice * 0.41, low: basePrice * 0.37, close: basePrice * 0.39, isGreen: true },
      { time: '42m', open: basePrice * 0.39, high: basePrice * 0.42, low: basePrice * 0.38, close: basePrice * 0.40, isGreen: true },
      { time: '40m', open: basePrice * 0.40, high: basePrice * 0.43, low: basePrice * 0.39, close: basePrice * 0.41, isGreen: true },
      { time: '38m', open: basePrice * 0.41, high: basePrice * 0.44, low: basePrice * 0.40, close: basePrice * 0.42, isGreen: true },
      { time: '36m', open: basePrice * 0.42, high: basePrice * 0.45, low: basePrice * 0.41, close: basePrice * 0.43, isGreen: true },
      { time: '34m', open: basePrice * 0.43, high: basePrice * 0.46, low: basePrice * 0.42, close: basePrice * 0.44, isGreen: true },
      { time: '32m', open: basePrice * 0.44, high: basePrice * 0.47, low: basePrice * 0.43, close: basePrice * 0.45, isGreen: true },
      { time: '30m', open: basePrice * 0.45, high: basePrice * 0.48, low: basePrice * 0.44, close: basePrice * 0.46, isGreen: true },
      { time: '28m', open: basePrice * 0.46, high: basePrice * 0.49, low: basePrice * 0.45, close: basePrice * 0.47, isGreen: true },
      { time: '26m', open: basePrice * 0.47, high: basePrice * 0.50, low: basePrice * 0.46, close: basePrice * 0.48, isGreen: true },
      { time: '24m', open: basePrice * 0.48, high: basePrice * 0.51, low: basePrice * 0.47, close: basePrice * 0.49, isGreen: true },
      { time: '22m', open: basePrice * 0.49, high: basePrice * 0.52, low: basePrice * 0.48, close: basePrice * 0.50, isGreen: true },
      { time: '20m', open: basePrice * 0.50, high: basePrice * 0.58, low: basePrice * 0.49, close: basePrice * 0.46, isGreen: false },
      { time: '18m', open: basePrice * 0.46, high: basePrice * 0.53, low: basePrice * 0.45, close: basePrice * 0.51, isGreen: true },
      { time: '16m', open: basePrice * 0.51, high: basePrice * 0.59, low: basePrice * 0.50, close: basePrice * 0.47, isGreen: false },
      { time: '14m', open: basePrice * 0.47, high: basePrice * 0.55, low: basePrice * 0.46, close: basePrice * 0.53, isGreen: true },
      { time: '12m', open: basePrice * 0.53, high: basePrice * 0.61, low: basePrice * 0.52, close: basePrice * 0.58, isGreen: true },
      { time: '10m', open: basePrice * 0.58, high: basePrice * 0.66, low: basePrice * 0.57, close: basePrice * 0.62, isGreen: true },
      { time: '8m', open: basePrice * 0.62, high: basePrice * 0.75, low: basePrice * 0.61, close: basePrice * 0.72, isGreen: true },
      { time: '6m', open: basePrice * 0.72, high: basePrice * 0.85, low: basePrice * 0.71, close: basePrice * 0.68, isGreen: false },
      { time: '4m', open: basePrice * 0.68, high: basePrice * 0.82, low: basePrice * 0.67, close: basePrice * 0.79, isGreen: true },
      { time: '2m', open: basePrice * 0.79, high: basePrice * 0.95, low: basePrice * 0.78, close: basePrice * 0.92, isGreen: true },
