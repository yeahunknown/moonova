...
const Portfolio = () => {
  ...
  const [chartData, setChartData] = useState(() => {
    ...
    return [
      { time: '90m', open: basePrice * 0.08, high: basePrice * 0.18, low: basePrice * 0.04, close: basePrice * 0.10, isGreen: true },
      { time: '88m', open: basePrice * 0.10, high: basePrice * 0.12, low: basePrice * 0.06, close: basePrice * 0.07, isGreen: false },
      { time: '86m', open: basePrice * 0.07, high: basePrice * 0.20, low: basePrice * 0.03, close: basePrice * 0.09, isGreen: true },
      { time: '84m', open: basePrice * 0.09, high: basePrice * 0.15, low: basePrice * 0.05, close: basePrice * 0.11, isGreen: true },
      { time: '82m', open: basePrice * 0.11, high: basePrice * 0.22, low: basePrice * 0.07, close: basePrice * 0.08, isGreen: false },
      { time: '80m', open: basePrice * 0.08, high: basePrice * 0.19, low: basePrice * 0.04, close: basePrice * 0.12, isGreen: true },
      { time: '78m', open: basePrice * 0.12, high: basePrice * 0.14, low: basePrice * 0.08, close: basePrice * 0.15, isGreen: true },
      { time: '76m', open: basePrice * 0.15, high: basePrice * 0.28, low: basePrice * 0.09, close: basePrice * 0.14, isGreen: false },
      { time: '74m', open: basePrice * 0.14, high: basePrice * 0.25, low: basePrice * 0.10, close: basePrice * 0.17, isGreen: true },
      { time: '72m', open: basePrice * 0.17, high: basePrice * 0.20, low: basePrice * 0.13, close: basePrice * 0.19, isGreen: true },
      { time: '70m', open: basePrice * 0.19, high: basePrice * 0.32, low: basePrice * 0.11, close: basePrice * 0.18, isGreen: false },
      { time: '68m', open: basePrice * 0.18, high: basePrice * 0.30, low: basePrice * 0.12, close: basePrice * 0.21, isGreen: true },
      { time: '66m', open: basePrice * 0.21, high: basePrice * 0.24, low: basePrice * 0.16, close: basePrice * 0.23, isGreen: true },
      { time: '64m', open: basePrice * 0.23, high: basePrice * 0.35, low: basePrice * 0.15, close: basePrice * 0.25, isGreen: true },
      { time: '62m', open: basePrice * 0.25, high: basePrice * 0.29, low: basePrice * 0.19, close: basePrice * 0.24, isGreen: false },
      { time: '60m', open: basePrice * 0.24, high: basePrice * 0.40, low: basePrice * 0.16, close: basePrice * 0.27, isGreen: true },
      { time: '58m', open: basePrice * 0.27, high: basePrice * 0.31, low: basePrice * 0.22, close: basePrice * 0.29, isGreen: true },
      { time: '56m', open: basePrice * 0.29, high: basePrice * 0.45, low: basePrice * 0.20, close: basePrice * 0.31, isGreen: true },
      { time: '54m', open: basePrice * 0.31, high: basePrice * 0.36, low: basePrice * 0.26, close: basePrice * 0.33, isGreen: true },
      { time: '52m', open: basePrice * 0.33, high: basePrice * 0.48, low: basePrice * 0.25, close: basePrice * 0.35, isGreen: true },
      { time: '50m', open: basePrice * 0.35, high: basePrice * 0.42, low: basePrice * 0.30, close: basePrice * 0.38, isGreen: true },
      { time: '48m', open: basePrice * 0.38, high: basePrice * 0.44, low: basePrice * 0.33, close: basePrice * 0.40, isGreen: true },
      { time: '46m', open: basePrice * 0.40, high: basePrice * 0.47, low: basePrice * 0.35, close: basePrice * 0.42, isGreen: true },
      { time: '44m', open: basePrice * 0.42, high: basePrice * 0.49, low: basePrice * 0.37, close: basePrice * 0.45, isGreen: true },
      { time: '42m', open: basePrice * 0.45, high: basePrice * 0.52, low: basePrice * 0.40, close: basePrice * 0.48, isGreen: true },
      { time: '40m', open: basePrice * 0.48, high: basePrice * 0.55, low: basePrice * 0.43, close: basePrice * 0.51, isGreen: true },
      { time: '38m', open: basePrice * 0.51, high: basePrice * 0.58, low: basePrice * 0.46, close: basePrice * 0.54, isGreen: true },
      { time: '36m', open: basePrice * 0.54, high: basePrice * 0.61, low: basePrice * 0.49, close: basePrice * 0.57, isGreen: true },
      { time: '34m', open: basePrice * 0.57, high: basePrice * 0.64, low: basePrice * 0.52, close: basePrice * 0.60, isGreen: true },
      { time: '32m', open: basePrice * 0.60, high: basePrice * 0.67, low: basePrice * 0.55, close: basePrice * 0.63, isGreen: true },
      { time: '30m', open: basePrice * 0.63, high: basePrice * 0.70, low: basePrice * 0.58, close: basePrice * 0.66, isGreen: true },
      { time: '28m', open: basePrice * 0.66, high: basePrice * 0.73, low: basePrice * 0.61, close: basePrice * 0.69, isGreen: true },
      { time: '26m', open: basePrice * 0.69, high: basePrice * 0.76, low: basePrice * 0.64, close: basePrice * 0.72, isGreen: true },
      { time: '24m', open: basePrice * 0.72, high: basePrice * 0.79, low: basePrice * 0.67, close: basePrice * 0.75, isGreen: true },
      { time: '22m', open: basePrice * 0.75, high: basePrice * 0.82, low: basePrice * 0.70, close: basePrice * 0.78, isGreen: true },
      { time: '20m', open: basePrice * 0.78, high: basePrice * 0.85, low: basePrice * 0.73, close: basePrice * 0.81, isGreen: true },
      { time: '18m', open: basePrice * 0.81, high: basePrice * 0.88, low: basePrice * 0.76, close: basePrice * 0.84, isGreen: true },
      { time: '16m', open: basePrice * 0.84, high: basePrice * 0.91, low: basePrice * 0.79, close: basePrice * 0.87, isGreen: true },
      { time: '14m', open: basePrice * 0.87, high: basePrice * 0.94, low: basePrice * 0.82, close: basePrice * 0.90, isGreen: true },
      { time: '12m', open: basePrice * 0.90, high: basePrice * 0.97, low: basePrice * 0.85, close: basePrice * 0.93, isGreen: true },
      { time: '10m', open: basePrice * 0.93, high: basePrice * 1.00, low: basePrice * 0.88, close: basePrice * 0.96, isGreen: true },
      { time: '8m', open: basePrice * 0.96, high: basePrice * 1.03, low: basePrice * 0.91, close: basePrice * 0.99, isGreen: true },
      { time: '6m', open: basePrice * 0.99, high: basePrice * 1.06, low: basePrice * 0.94, close: basePrice * 1.02, isGreen: true },
      { time: '4m', open: basePrice * 1.02, high: basePrice * 1.09, low: basePrice * 0.97, close: basePrice * 1.05, isGreen: true },
      { time: '2m', open: basePrice * 1.05, high: basePrice * 1.12, low: basePrice * 1.00, close: basePrice * 1.08, isGreen: true },
      { time: 'now', open: basePrice * 1.08, high: basePrice * 1.15, low: basePrice * 1.03, close: basePrice, isGreen: basePrice >= basePrice * 1.08 },
    ];
  });
