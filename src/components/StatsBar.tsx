      ...
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Stat
            ...
            delay={0}
          />
          <Stat icon={<Users className="h-5 w-5 text-accent" />} value="12,750" label="Active Users" delay={0.1} />
          <Stat icon={<BarChart3 className="h-5 w-5 text-secondary" />} value="$27.4M" label="Total Volume" delay={0.2} />
          <Stat
